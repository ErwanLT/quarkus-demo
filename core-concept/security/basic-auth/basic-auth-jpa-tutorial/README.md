# Basic Auth JPA - Taverne

Ce module montre comment securiser la reserve de nourriture et de biere d'une taverne avec **Basic Auth** et des utilisateurs stockes en base via **security-jpa**.
