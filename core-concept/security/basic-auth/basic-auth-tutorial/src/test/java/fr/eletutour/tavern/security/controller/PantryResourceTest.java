package fr.eletutour.tavern.security.controller;
...
class PantryResourceTest {
    ...
    @Test
    @DisplayName("Le keeper peut acceder a /pantry")
    ...
    @Test
    @DisplayName("Le supplier n'est pas autorise sur /pantry (403)")
    ...
    @Test
    @DisplayName("Sans authentification, /cellar doit renvoyer 401")
    void testCellarUnauthenticated() {
        given()
                .when().get("/api/tavern/cellar")
                .then()
                .statusCode(401);
